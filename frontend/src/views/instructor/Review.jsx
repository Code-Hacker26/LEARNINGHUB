                                ...
                                <div className="card-body">
                                    ...
                                    <form className="row mb-4 gx-2">
                                        <div className="col-xl-7 col-lg-6 col-md-4 col-12 mb-2 mb-lg-0">
                                          <input type="text" onChange={handleFilterByCourse} className='form-control' placeholder='search by course' />
                                        </div>
                                                        ...
                                                        <div class="collapse" id={`collapse${r.id}`}>
                                                            <div class="card card-body">
                                                                <div>
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" onClick={()=>handleSubmitReply(r.id)}>Send Response <i className='fas fa-paper-plane'> </i></button>
                                                                </div>
                                                            </div>
                                                        </div>
